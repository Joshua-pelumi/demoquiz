...
function showResultBox(){
    ...
    if(userScore > 3){
        let scoreTag =  '<span> and congrats🥉, you got <p>' + userScore + '</p> out of <p>' + questions.lenth + '</p> </span>';
        scoreText.innerHTML = scoreTag;
    }
    else if(userScore > 1){
        let scoreTag =  '<span> and nice, you got only <p>' + userScore + '</p> out of <p>' + questions.lenth + '</p> </span>';
        scoreText.innerHTML = scoreTag;
    }
    else{
        let scoreTag =  '<span> and Oops, you got <p>' + userScore + '</p> out of <p>' + questions.lenth + '</p> </span>';
        scoreText.innerHTML = scoreTag;
    }
}
